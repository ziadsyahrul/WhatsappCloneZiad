...
class StatusUpdateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        progress_layout_status.setOnTouchListener { v, event -> true }
    ...
    private fun storageImage(imageUri: Uri?) {
        if (imageUri != null && userId != null) {
            ...
            progress_layout_status.visibility = View.VISIBLE
            // menyimpan gambar status di firebase storage dengan nama tambahan _status
                ...
                .addOnSuccessListener {
                    filePath.downloadUrl
                        .addOnSuccessListener {
                            ...
                            progress_layout_status.visibility = View.GONE
                        }
